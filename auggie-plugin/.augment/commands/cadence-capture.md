...
argument-hint: '"<thought>" | --from <path> --source <name>'
---
...
3. **Dispatch the `capture-ingest` subagent.** Use the subagent dispatcher with `subagent_type: capture-ingest`. Prompt shape:
   ```
