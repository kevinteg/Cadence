...
- [ ] Wire living docs into the ask surface: wiki/index.md entries + /wiki ask coverage with citations; index them in cadence find.
- [ ] Surface anchored docs on entity views: /start <project>, cadence status <project>, and the pursuit workspace list their doc shelf.
